package Inheritance;
 ...
 abstract class Veh1 {
    ...
    public Veh1(String make, String model, int year, String fuelType, double fuelEfficiency) {
        this.make = make;
        this.model = model;
        this.year = year;
 ...
 class Motor1 extends Veh1 {
	    private double engineDisplacement;

	    public Motor1(String make, String model, int year, String fuelType, double fuelEfficiency) {
	        super(make, model, year, fuelType, fuelEfficiency);
