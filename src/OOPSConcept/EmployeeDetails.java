...
public class EmployeeDetails 
{
	...
	{
		Employee employee1 = new Employee("Ram", 50000, LocalDate.parse("2021-04-01"));
	    Employee employee2 = new Employee("Shyam", 70000, LocalDate.parse("2015-04-01"));
	    Employee employee3 = new Employee("Mohan", 50000, LocalDate.parse("2011-01-15"));
